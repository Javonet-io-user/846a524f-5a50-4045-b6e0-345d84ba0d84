...
public class RelationRequestDetails extends RelationRequest {
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setIsLocal(Nullable<java.lang.Boolean> value) {
    try {
      javonetHandle.set("IsLocal", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  @MethodTypeAnnotation(type = "GetField")
  public Nullable<java.lang.Boolean> getIsLocal() {
    try {
      Object res = javonetHandle.<NObject>get("IsLocal");
      if (res == null) return null;
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setSide(RelationRequestSide value) {
    try {
  ...
  @MethodTypeAnnotation(type = "GetField")
  public RelationRequestSide getSide() {
    try {
      Object res = javonetHandle.<NEnum>get("Side");
      if (res == null) return null;
      return RelationRequestSide.valueOf(((NEnum) res).getValueName());
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setAcceptionDate(Nullable<DateTime> value) {
    try {
      javonetHandle.set("AcceptionDate", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  @MethodTypeAnnotation(type = "GetField")
  public Nullable<DateTime> getAcceptionDate() {
    try {
      Object res = javonetHandle.<NObject>get("AcceptionDate");
      if (res == null) return null;
      return new Nullable<DateTime>((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public RelationRequestDetails() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Korus.Eds.Api.RelationRequestDetails");
  ...
  public RelationRequestDetails(NObject handle) {
    super(handle);
