...
public class Torg12ForBuyerIdentSeller {
  ...
  public Torg12ForBuyerIdentSeller() {
    try {
      javonetHandle = Javonet.New("Korus.Eds.Workflow.Xml.WayBill.Torg12ForBuyerIdentSeller");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public Torg12ForBuyerIdentSeller(NObject handle) {
