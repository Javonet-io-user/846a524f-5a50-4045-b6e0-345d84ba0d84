...
public class RejectWithRouteUpdateBody {
  ...
  public RejectWithRouteUpdateBody() {
    try {
      javonetHandle = Javonet.New("Korus.Eds.Api.RejectWithRouteUpdateBody");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public RejectWithRouteUpdateBody(NObject handle) {
