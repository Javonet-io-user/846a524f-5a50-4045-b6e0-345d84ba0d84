...
public class CustomerDocument implements IXmlDocument {
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setInfo(CustomerInfo value) {
    try {
  ...
  public CustomerInfo getInfo() {
    try {
      ...
      if (res == null) return null;
      return new CustomerInfo((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public CustomerDocument() {
    try {
      javonetHandle = Javonet.New("Korus.Eds.Workflow.Xml.AcceptanceCertificate.CustomerDocument");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public CustomerDocument(NObject handle) {
