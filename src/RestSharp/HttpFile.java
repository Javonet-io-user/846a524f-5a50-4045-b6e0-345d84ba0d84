...
public class HttpFile {
  ...
  public void setContentLength(java.lang.Long value) {
    try {
      javonetHandle.set("ContentLength", value);
  ...
  public java.lang.Long getContentLength() {
    try {
      java.lang.Long res = javonetHandle.get("ContentLength");
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setWriter(ActionT<Stream> value) {
    try {
  ...
  @MethodTypeAnnotation(type = "GetField")
  public ActionT<Stream> getWriter() {
    try {
  ...
  public HttpFile() {
    try {
      javonetHandle = Javonet.New("RestSharp.HttpFile");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public HttpFile(NObject handle) {
