...
public class AcceptanceCertificateAcceptInfo {
  ...
  public AcceptanceCertificateAcceptInfo() {
    try {
      javonetHandle = Javonet.New("Korus.Eds.Api.AcceptanceCertificateAcceptInfo");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public AcceptanceCertificateAcceptInfo(NObject handle) {
