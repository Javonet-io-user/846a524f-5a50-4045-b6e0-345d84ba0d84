...
public class PersonName implements IPerson {
  ...
  public PersonName() {
    try {
      javonetHandle = Javonet.New("Sphere.Common.Xml.PersonName");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public PersonName(IPerson person) {
    try {
      javonetHandle = Javonet.New("Sphere.Common.Xml.PersonName", person);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public PersonName(
    ...
    try {
      javonetHandle = Javonet.New("Sphere.Common.Xml.PersonName", lastName, firstName, middleName);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
