...
public class NoticeOfAssignment {
  ...
  public NoticeOfAssignment() {
    try {
      javonetHandle = Javonet.New("Korus.Eds.Api.Forms.NoticeOfAssignment");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public NoticeOfAssignment(NObject handle) {
