...
public class AttributeCollection implements ICollection, IEnumerable, Iterable<Object> {
  ...
  public AttributeCollection(Attribute[] attributes) {
    try {
      javonetHandle =
          Javonet.New("System.ComponentModel.AttributeCollection", new Object[] {attributes});
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public AttributeCollection(NObject handle) {
