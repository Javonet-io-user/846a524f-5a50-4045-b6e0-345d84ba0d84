...
public class VatType {
  ...
  public VatType() {
    try {
      javonetHandle = Javonet.New("Korus.Eds.Workflow.Xml.Common.VatType");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public VatType(java.lang.String amount) {
    try {
      javonetHandle = Javonet.New("Korus.Eds.Workflow.Xml.Common.VatType", amount);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public VatType(NObject handle) {
