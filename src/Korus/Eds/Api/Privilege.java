...
public class Privilege {
  ...
  public java.lang.Long getParentId() {
    try {
      java.lang.Long res = javonetHandle.get("ParentId");
      if (res == null) return null;
      return res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public java.lang.Long getGroupId() {
    try {
      java.lang.Long res = javonetHandle.get("GroupId");
      if (res == null) return null;
      return res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public void setIsAvailable(java.lang.Boolean value) {
    try {
      javonetHandle.set("IsAvailable", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.Boolean getIsAvailable() {
    try {
      java.lang.Boolean res = javonetHandle.get("IsAvailable");
  ...
  public Privilege() {
    try {
      javonetHandle = Javonet.New("Korus.Eds.Api.Privilege");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public Privilege(NObject handle) {
