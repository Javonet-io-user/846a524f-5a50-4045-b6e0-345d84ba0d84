...
public class AcceptWithRouteUpdateBody {
  ...
  public AcceptWithRouteUpdateBody() {
    try {
      javonetHandle = Javonet.New("Korus.Eds.Api.AcceptWithRouteUpdateBody");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public AcceptWithRouteUpdateBody(NObject handle) {
