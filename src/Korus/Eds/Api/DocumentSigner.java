...
public class DocumentSigner {
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setSignerType(SignerType value) {
    try {
      javonetHandle.set("SignerType", NEnum.fromJavaEnum(value));
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public SignerType getSignerType() {
    try {
      Object res = javonetHandle.<NEnum>get("SignerType");
      if (res == null) return null;
      return SignerType.valueOf(((NEnum) res).getValueName());
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public DocumentSigner() {
    try {
      javonetHandle = Javonet.New("Korus.Eds.Api.DocumentSigner");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public DocumentSigner(NObject handle) {
