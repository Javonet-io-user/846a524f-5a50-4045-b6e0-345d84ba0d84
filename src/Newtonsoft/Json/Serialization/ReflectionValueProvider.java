...
public class ReflectionValueProvider implements IValueProvider {
  protected NObject javonetHandle;

  public ReflectionValueProvider(MemberInfo memberInfo) {
    try {
      javonetHandle =
          Javonet.New("Newtonsoft.Json.Serialization.ReflectionValueProvider", memberInfo);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public ReflectionValueProvider(NObject handle) {
