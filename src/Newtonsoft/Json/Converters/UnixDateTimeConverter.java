...
public class UnixDateTimeConverter extends DateTimeConverterBase {
  protected NObject javonetHandle;

  public UnixDateTimeConverter() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Newtonsoft.Json.Converters.UnixDateTimeConverter");
  ...
  public UnixDateTimeConverter(NObject handle) {
    super(handle);
