...
public class Torg12ForBuyerDocument implements IXmlDocument {
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setIdentification(Torg12ForBuyerIdentSeller value) {
    try {
      javonetHandle.set("Identification", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  @MethodTypeAnnotation(type = "GetField")
  public Torg12ForBuyerIdentSeller getIdentification() {
    try {
      Object res = javonetHandle.<NObject>get("Identification");
      if (res == null) return null;
      return new Torg12ForBuyerIdentSeller((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setInfo(Torg12ForBuyerInfo value) {
    try {
  ...
  @MethodTypeAnnotation(type = "GetField")
  public Torg12ForBuyerInfo getInfo() {
    try {
      Object res = javonetHandle.<NObject>get("Info");
      if (res == null) return null;
      return new Torg12ForBuyerInfo((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public Torg12ForBuyerDocument() {
    try {
      javonetHandle = Javonet.New("Korus.Eds.Workflow.Xml.WayBill.Torg12ForBuyerDocument");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public Torg12ForBuyerDocument(NObject handle) {
