...
public class JwtAuthenticator implements IAuthenticator {
  ...
  public JwtAuthenticator(java.lang.String accessToken) {
    try {
      javonetHandle = Javonet.New("RestSharp.Authenticators.JwtAuthenticator", accessToken);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public JwtAuthenticator(NObject handle) {
