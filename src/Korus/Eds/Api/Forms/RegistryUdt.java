...
public class RegistryUdt {
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setDeliveries(List<Delivery> value) {
    try {
      javonetHandle.set("Deliveries", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public List<Delivery> getDeliveries() {
    try {
      Object res = javonetHandle.<NObject>get("Deliveries");
      if (res == null) return null;
      return new List<Delivery>((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public RegistryUdt() {
    try {
      javonetHandle = Javonet.New("Korus.Eds.Api.Forms.RegistryUdt");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public RegistryUdt(NObject handle) {
