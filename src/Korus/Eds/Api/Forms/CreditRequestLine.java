...
public class CreditRequestLine {
  protected NObject javonetHandle;
  /** SetProperty */
  @MethodTypeAnnotation(type = "SetField")
  public void setLineNumber(java.lang.Integer value) {
    try {
      javonetHandle.set("LineNumber", value);
  ...
  public CreditRequestLine() {
    try {
      javonetHandle = Javonet.New("Korus.Eds.Api.Forms.CreditRequestLine");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public CreditRequestLine(NObject handle) {
