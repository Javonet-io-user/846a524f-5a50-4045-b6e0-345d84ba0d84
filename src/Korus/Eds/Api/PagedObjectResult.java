...
public class PagedObjectResult {
  protected NObject javonetHandle;
  /** SetProperty */
  @MethodTypeAnnotation(type = "SetField")
  public void setResult(Object[] value) {
    try {
      javonetHandle.set("Result", new Object[] {value});
  ...
  public Object[] getResult(Class<?> returnArrayType) {
    try {
  ...
  public PagedObjectResult() {
    try {
      javonetHandle = Javonet.New("Korus.Eds.Api.PagedObjectResult");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public PagedObjectResult(NObject handle) {
  ...
  public static <T> PagedObjectResult FromPagedResult(PagedResult<T> pagedResult) {
    try {
      Object res =
          Javonet.getType("Korus.Eds.Api.PagedObjectResult").invoke("FromPagedResult", pagedResult);
      if (res == null) return null;
      return new PagedObjectResult((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
