...
public class RelationDocumentType {
  ...
  public RelationDocumentType() {
    try {
      javonetHandle = Javonet.New("Korus.Eds.Api.RelationDocumentType");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public RelationDocumentType(NObject handle) {
