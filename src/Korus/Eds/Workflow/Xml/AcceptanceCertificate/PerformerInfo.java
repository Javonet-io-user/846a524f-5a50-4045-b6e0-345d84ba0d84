...
public class PerformerInfo {
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setPerformer(ParticipantInfo value) {
    try {
  ...
  @MethodTypeAnnotation(type = "GetField")
  public ParticipantInfo getPerformer() {
    try {
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setWorks(WorksInfo[] value) {
    try {
      javonetHandle.set("Works", new Object[] {value});
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  @MethodTypeAnnotation(type = "GetField")
  public WorksInfo[] getWorks(Class<?> returnArrayType) {
    try {
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setPassed(PassedInfo value) {
    try {
      javonetHandle.set("Passed", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  @MethodTypeAnnotation(type = "GetField")
  public PassedInfo getPassed() {
    try {
      Object res = javonetHandle.<NObject>get("Passed");
      if (res == null) return null;
      return new PassedInfo((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public PerformerInfo() {
    try {
      javonetHandle = Javonet.New("Korus.Eds.Workflow.Xml.AcceptanceCertificate.PerformerInfo");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public PerformerInfo(NObject handle) {
