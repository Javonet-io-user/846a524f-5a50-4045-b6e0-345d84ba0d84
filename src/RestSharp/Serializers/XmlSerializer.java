...
public class XmlSerializer implements ISerializer {
  ...
  public XmlSerializer() {
    try {
      javonetHandle = Javonet.New("RestSharp.Serializers.XmlSerializer");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public XmlSerializer(java.lang.String namespace) {
    try {
      javonetHandle = Javonet.New("RestSharp.Serializers.XmlSerializer", namespace);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public XmlSerializer(NObject handle) {
