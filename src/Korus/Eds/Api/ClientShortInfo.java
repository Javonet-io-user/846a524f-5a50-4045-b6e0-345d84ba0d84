...
public class ClientShortInfo {
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setIsHead(java.lang.Boolean value) {
    try {
      javonetHandle.set("IsHead", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.Boolean getIsHead() {
    try {
      java.lang.Boolean res = javonetHandle.get("IsHead");
  ...
  public ClientShortInfo() {
    try {
      javonetHandle = Javonet.New("Korus.Eds.Api.ClientShortInfo");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public ClientShortInfo(NObject handle) {
