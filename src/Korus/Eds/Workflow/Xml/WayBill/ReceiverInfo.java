...
public class ReceiverInfo {
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setConsignee(ReceiptSignerInfo value) {
    try {
  ...
  @MethodTypeAnnotation(type = "GetField")
  public ReceiptSignerInfo getConsignee() {
    try {
  ...
  public ReceiverInfo() {
    try {
      javonetHandle = Javonet.New("Korus.Eds.Workflow.Xml.WayBill.ReceiverInfo");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public ReceiverInfo(NObject handle) {
