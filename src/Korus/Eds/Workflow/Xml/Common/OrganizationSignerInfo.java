...
public class OrganizationSignerInfo implements ISigner {
  ...
  public OrganizationSignerInfo() {
    try {
      javonetHandle = Javonet.New("Korus.Eds.Workflow.Xml.Common.OrganizationSignerInfo");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public OrganizationSignerInfo(NObject handle) {
