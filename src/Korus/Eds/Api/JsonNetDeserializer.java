...
public class JsonNetDeserializer implements IDeserializer {
  ...
  public JsonNetDeserializer() {
    try {
      javonetHandle = Javonet.New("Korus.Eds.Api.JsonNetDeserializer");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public JsonNetDeserializer(NObject handle) {
