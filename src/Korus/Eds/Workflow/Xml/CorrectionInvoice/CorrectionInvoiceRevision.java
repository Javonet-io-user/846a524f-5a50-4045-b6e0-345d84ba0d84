...
public class CorrectionInvoiceRevision implements IDocumentInfo {
  ...
  public CorrectionInvoiceRevision() {
    try {
      javonetHandle =
          Javonet.New("Korus.Eds.Workflow.Xml.CorrectionInvoice.CorrectionInvoiceRevision");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public CorrectionInvoiceRevision(java.lang.String number, DateTime date) {
    try {
      javonetHandle =
          Javonet.New(
              "Korus.Eds.Workflow.Xml.CorrectionInvoice.CorrectionInvoiceRevision", number, date);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public CorrectionInvoiceRevision(NObject handle) {
