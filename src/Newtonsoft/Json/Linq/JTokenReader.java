...
public class JTokenReader extends JsonReader implements IDisposable, IJsonLineInfo {
  protected NObject javonetHandle;
  /** GetProperty */
  @MethodTypeAnnotation(type = "GetField")
  public JToken getCurrentToken() {
    try {
  ...
  @MethodTypeAnnotation(type = "GetField")
  public java.lang.String getPathAsJTokenReader() {
    try {
  ...
  public JTokenReader(JToken token) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Newtonsoft.Json.Linq.JTokenReader", token);
  ...
  public JTokenReader(JToken token, java.lang.String initialPath) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Newtonsoft.Json.Linq.JTokenReader", token, initialPath);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  ...
  public JTokenReader(NObject handle) {
    super(handle);
