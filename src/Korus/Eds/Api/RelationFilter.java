...
public class RelationFilter extends DataFilter {
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setDocumentTypeId(Nullable<java.lang.Long> value) {
    try {
  ...
  public void setDocumentRelationType(Nullable<DocumentRelationType> value) {
    try {
      javonetHandle.set("DocumentRelationType", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public Nullable<DocumentRelationType> getDocumentRelationType() {
    try {
      Object res = javonetHandle.<NObject>get("DocumentRelationType");
      if (res == null) return null;
      return new Nullable<DocumentRelationType>((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public RelationFilter() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Korus.Eds.Api.RelationFilter");
  ...
  public RelationFilter(NObject handle) {
    super(handle);
