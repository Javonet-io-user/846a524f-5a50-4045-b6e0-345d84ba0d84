...
public class JsonArrayContract extends JsonContainerContract {
  ...
  public jio.System.Type getCollectionItemType() {
    try {
      Object res = javonetHandle.<NObject>get("CollectionItemType");
  ...
  @MethodTypeAnnotation(type = "GetField")
  public java.lang.Boolean getIsMultidimensionalArray() {
    try {
      java.lang.Boolean res = javonetHandle.get("IsMultidimensionalArray");
  ...
  public JsonArrayContract(jio.System.Type underlyingType) {
    super((NObject) null);
    try {
      javonetHandle =
          Javonet.New("Newtonsoft.Json.Serialization.JsonArrayContract", underlyingType);
  ...
  public JsonArrayContract(NObject handle) {
    super(handle);
