...
public class BuyerSellerIdentification {
  ...
  public BuyerSellerIdentification() {
    try {
      javonetHandle =
          Javonet.New("Korus.Eds.Workflow.Xml.AcceptanceCertificate.BuyerSellerIdentification");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public BuyerSellerIdentification(IClient abonent) {
    try {
      javonetHandle =
          Javonet.New(
              "Korus.Eds.Workflow.Xml.AcceptanceCertificate.BuyerSellerIdentification", abonent);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
