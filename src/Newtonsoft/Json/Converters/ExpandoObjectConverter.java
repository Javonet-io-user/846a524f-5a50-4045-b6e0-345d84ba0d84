...
public class ExpandoObjectConverter extends JsonConverter {
  ...
  public java.lang.Boolean getCanWriteAsExpandoObjectConverter() {
    try {
  ...
  public ExpandoObjectConverter() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Newtonsoft.Json.Converters.ExpandoObjectConverter");
  ...
  public ExpandoObjectConverter(NObject handle) {
    super(handle);
