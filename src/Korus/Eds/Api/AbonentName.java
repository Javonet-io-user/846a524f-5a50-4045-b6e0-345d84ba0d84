...
public class AbonentName implements IAbonentName, IAbonent {
  protected NObject javonetHandle;
  /** SetProperty */
  @MethodTypeAnnotation(type = "SetField")
  public void setId(java.lang.Long value) {
    try {
      javonetHandle.explicitInterface("Korus.Eds.Core.Data.IAbonentName").invoke("set_Id", value);
  ...
  public java.lang.Long getId() {
    try {
      java.lang.Long res =
          javonetHandle.explicitInterface("Korus.Eds.Core.Data.IAbonentName").invoke("get_Id");
  ...
  public java.lang.String getKpp() {
    try {
      java.lang.String res =
          javonetHandle.explicitInterface("Korus.Eds.Core.Data.IAbonentName").invoke("get_Kpp");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public AbonentName() {
    try {
      javonetHandle = Javonet.New("Korus.Eds.Api.AbonentName");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public AbonentName(NObject handle) {
