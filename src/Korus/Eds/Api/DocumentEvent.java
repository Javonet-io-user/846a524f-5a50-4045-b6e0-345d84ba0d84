...
public class DocumentEvent {
  ...
  public void setTicketId(Nullable<java.lang.Long> value) {
    try {
      javonetHandle.set("TicketId", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public Nullable<java.lang.Long> getTicketId() {
    try {
      Object res = javonetHandle.<NObject>get("TicketId");
      if (res == null) return null;
  ...
  public void setExtendedTicketType(Nullable<ExtendedDocumentType> value) {
    try {
      javonetHandle.set("ExtendedTicketType", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public Nullable<ExtendedDocumentType> getExtendedTicketType() {
    try {
      Object res = javonetHandle.<NObject>get("ExtendedTicketType");
      if (res == null) return null;
      return new Nullable<ExtendedDocumentType>((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public void setEventType(DocumentEventType value) {
    try {
      javonetHandle.set("EventType", NEnum.fromJavaEnum(value));
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public DocumentEventType getEventType() {
    try {
      ...
      if (res == null) return null;
      return DocumentEventType.valueOf(((NEnum) res).getValueName());
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  @MethodTypeAnnotation(type = "GetField")
  public java.lang.Boolean getTicketIdSpecified() {
    try {
      java.lang.Boolean res = javonetHandle.get("TicketIdSpecified");
  ...
  public DocumentEvent() {
    try {
      javonetHandle = Javonet.New("Korus.Eds.Api.DocumentEvent");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public DocumentEvent(NObject handle) {
