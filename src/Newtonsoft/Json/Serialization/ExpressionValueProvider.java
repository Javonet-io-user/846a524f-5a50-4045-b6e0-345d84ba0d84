...
public class ExpressionValueProvider implements IValueProvider {
  protected NObject javonetHandle;

  public ExpressionValueProvider(MemberInfo memberInfo) {
    try {
      javonetHandle =
          Javonet.New("Newtonsoft.Json.Serialization.ExpressionValueProvider", memberInfo);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public ExpressionValueProvider(NObject handle) {
