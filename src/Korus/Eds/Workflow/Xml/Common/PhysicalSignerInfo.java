...
public class PhysicalSignerInfo implements ISigner {
  protected NObject javonetHandle;
  /** SetProperty */
  @MethodTypeAnnotation(type = "SetField")
  public void setRegRequisites(java.lang.String value) {
    try {
      javonetHandle.set("RegRequisites", value);
  ...
  public java.lang.String getRegRequisites() {
    try {
      java.lang.String res = javonetHandle.get("RegRequisites");
      if (res == null) return "";
  ...
  public PhysicalSignerInfo() {
    try {
      javonetHandle = Javonet.New("Korus.Eds.Workflow.Xml.Common.PhysicalSignerInfo");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public PhysicalSignerInfo(NObject handle) {
