...
public class Client {
  ...
  public void setCompanyType(CompanyType value) {
    try {
      javonetHandle.set("CompanyType", NEnum.fromJavaEnum(value));
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public CompanyType getCompanyType() {
    try {
      Object res = javonetHandle.<NEnum>get("CompanyType");
      if (res == null) return null;
      return CompanyType.valueOf(((NEnum) res).getValueName());
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public void setRegistryNumber(java.lang.String value) {
    try {
      javonetHandle.set("RegistryNumber", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.String getRegistryNumber() {
    try {
      java.lang.String res = javonetHandle.get("RegistryNumber");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public Client() {
    try {
      javonetHandle = Javonet.New("Korus.Eds.Api.Client");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public Client(NObject handle) {
