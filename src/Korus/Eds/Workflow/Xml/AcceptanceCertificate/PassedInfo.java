...
public class PassedInfo {
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setSignature(ReceiptSignerInfo value) {
    try {
  ...
  @MethodTypeAnnotation(type = "GetField")
  public ReceiptSignerInfo getSignature() {
    try {
  ...
  public PassedInfo() {
    try {
      javonetHandle = Javonet.New("Korus.Eds.Workflow.Xml.AcceptanceCertificate.PassedInfo");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public PassedInfo(NObject handle) {
