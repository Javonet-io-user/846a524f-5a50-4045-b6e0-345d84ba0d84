...
public class CorrectionInvoiceRowTotals {
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setVatSum(VatSumType value) {
    try {
  ...
  public CorrectionInvoiceRowTotals() {
    try {
      javonetHandle =
          Javonet.New("Korus.Eds.Workflow.Xml.CorrectionInvoice.CorrectionInvoiceRowTotals");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public CorrectionInvoiceRowTotals(NObject handle) {
