...
public class JTokenWriter extends JsonWriter implements IDisposable {
  ...
  public JTokenWriter(JContainer container) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Newtonsoft.Json.Linq.JTokenWriter", container);
  ...
  public JTokenWriter() {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Newtonsoft.Json.Linq.JTokenWriter");
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  ...
  public JTokenWriter(NObject handle) {
    super(handle);
