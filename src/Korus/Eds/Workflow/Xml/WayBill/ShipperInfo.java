...
public class ShipperInfo {
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setShipper(ParticipantInfo value) {
    try {
  ...
  @MethodTypeAnnotation(type = "GetField")
  public ParticipantInfo getShipper() {
    try {
  ...
  public void setSubdivision(java.lang.String value) {
    try {
      javonetHandle.set("Subdivision", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.String getSubdivision() {
    try {
      java.lang.String res = javonetHandle.get("Subdivision");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public ShipperInfo() {
    try {
      javonetHandle = Javonet.New("Korus.Eds.Workflow.Xml.WayBill.ShipperInfo");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
