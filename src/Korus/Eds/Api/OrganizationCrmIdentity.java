...
public class OrganizationCrmIdentity {
  protected NObject javonetHandle;
  /** SetProperty */
  @MethodTypeAnnotation(type = "SetField")
  public void setOrganizationId(java.lang.String value) {
    try {
      javonetHandle.set("OrganizationId", value);
  ...
  public java.lang.String getOrganizationId() {
    try {
      java.lang.String res = javonetHandle.get("OrganizationId");
      if (res == null) return "";
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setFolderUid(java.lang.String value) {
    try {
      javonetHandle.set("FolderUid", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.String getFolderUid() {
    try {
      java.lang.String res = javonetHandle.get("FolderUid");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public OrganizationCrmIdentity() {
    try {
      javonetHandle = Javonet.New("Korus.Eds.Api.OrganizationCrmIdentity");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public OrganizationCrmIdentity(NObject handle) {
