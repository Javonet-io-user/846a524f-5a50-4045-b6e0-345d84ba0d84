...
public class Certificate {
  ...
  public void setSerialNumber(java.lang.String value) {
    try {
      javonetHandle.set("SerialNumber", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.String getSerialNumber() {
    try {
      java.lang.String res = javonetHandle.get("SerialNumber");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public void setNotBefore(DateTime value) {
    try {
      javonetHandle.set("NotBefore", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public DateTime getNotBefore() {
    try {
      Object res = javonetHandle.<NObject>get("NotBefore");
      if (res == null) return null;
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setNotAfter(DateTime value) {
    try {
      javonetHandle.set("NotAfter", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public DateTime getNotAfter() {
    try {
      Object res = javonetHandle.<NObject>get("NotAfter");
      if (res == null) return null;
      return new DateTime((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public Certificate() {
    try {
      javonetHandle = Javonet.New("Korus.Eds.Api.Certificate");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
