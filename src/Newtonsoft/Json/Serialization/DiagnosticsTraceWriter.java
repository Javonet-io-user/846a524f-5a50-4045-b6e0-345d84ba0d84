...
public class DiagnosticsTraceWriter implements ITraceWriter {
  ...
  public DiagnosticsTraceWriter() {
    try {
      javonetHandle = Javonet.New("Newtonsoft.Json.Serialization.DiagnosticsTraceWriter");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public DiagnosticsTraceWriter(NObject handle) {
