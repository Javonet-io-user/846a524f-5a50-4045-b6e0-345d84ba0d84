...
public class BaseInfo {
  ...
  public void setAdditionalInfo(java.lang.String value) {
    try {
      javonetHandle.set("AdditionalInfo", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public java.lang.String getAdditionalInfo() {
    try {
      java.lang.String res = javonetHandle.get("AdditionalInfo");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public BaseInfo() {
    try {
      javonetHandle = Javonet.New("Korus.Eds.Workflow.Xml.WayBill.BaseInfo");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public BaseInfo(NObject handle) {
